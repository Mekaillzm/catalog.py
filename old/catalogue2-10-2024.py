...
import math
import sys
if 'R:\\Misc\\python\\pkgs' not in sys.path: sys.path.append('R:\\Misc\\python\\pkgs')
...
class catalogue():
    ...
    def updateText(self):
        ...
        try:self.columnDTypes=self.textDf.loc['columnDTypes'].values[0].split('♣')
            ...
            self.columnDTypes= calculateDefaultList('str')
        try:
            ...
            self.columnDefaults=calculateDefaultList('Unknown')
